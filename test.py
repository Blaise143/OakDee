...
model = torchvision.models.detection.fasterrcnn_mobilenet_v3_large_320_fpn(parameter='DEFAULT')
torch.save(model.state_dict(), 'model.pth')
# model_2 = torch.onnx.export(model.state_di)
nnPath = str(Path(__file__).parent / Path('..models/mobilenet.blob'))
# print())) #/ Path('../models/mobilenet-ssd_openvino_2021.4_6shave.blob')).resolve().absolute())
# print(sys.argv)
'''
